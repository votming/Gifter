...
def upgrade() -> None:
    ...
    currencies = [
        {'official_name': 'US Dollars', 'name': 'dollar', 'name_plural': 'dollars', 'code': 'usd', 'symbol': '$'},
        {'official_name': 'Euro', 'name': 'euro', 'name_plural': 'euros', 'code': 'eur', 'symbol': '€'},
        {'official_name': 'Pound sterling', 'name': 'pound sterling', 'name_plural': 'pounds sterling', 'code': 'gbp',
         'symbol': '£'}]
    currencies = [{
        # 1
        'code': 'USD',
    ...
    countries = [{'name': 'United States', 'code': 'US', 'currency_id': 1, 'bank_name': 'US Bank'},
                 {'name': 'United Kingdom', 'code': 'GB', 'currency_id': 3, 'bank_name': 'UK Bank'},
                 {'name': 'Estonia', 'code': 'EN', 'currency_id': 1, 'bank_name': 'Estonian  Bank'}]
    countries = [
        {'name': 'United States', 'code': 'US', 'currency_id': 1, 'bank_name': 'US Bank', 'demonym': 'american',
         'demonym_plural': 'americans', },
    ...
    titles = [
        {'gender': None, 'language_id': 1, 'country_id': None,
         'template': "{offer_hero}’s latest investment has experts in awe and big banks terrified"},
        {'gender': None, 'language_id': 1, 'country_id': None,
         'template': "Special report: {offer_hero}’s Latest Investment Has Experts in Awe And Big Banks Terrified"},
        {'gender': None, 'language_id': 1, 'country_id': None,
         'template': "{offer_hero}'s investments impress experts and scare the minds of big banks"},
        {'gender': None, 'language_id': 1, 'country_id': None,
         'template': "{offer_hero} invests $12 million in new trading platform – releases to public, making ordinary people wealthy"},
        {'gender': None, 'language_id': 1, 'country_id': None,
         'template': "{offer_hero} reveals 'the rich society' secret: technology allowing everyone to earn millions"},
        {'gender': None, 'language_id': 1, 'country_id': None,
         'template': "{offer_hero} shocked everyone in the studio by revealing how he is making an extra £128K every month"},
        {'gender': None, 'language_id': 1, 'country_id': 2,
         'template': "{offer_hero} shocked everyone in the studio by revealing how he is making an extra $128K every month"},
        {'gender': None, 'language_id': 1, 'country_id': None,
         'template': "{offer_hero}, Banks #1 wanted person, shared secret information on how to make a fortune"},
        {'gender': None, 'language_id': 1, 'country_id': None,
         'template': "{offer_hero} accidentally revealed this top secret about a loophole that will make any {country_demonym_capitalized} rich"},
        {'gender': None, 'language_id': 1, 'country_id': None,
         'template': "The gift of billionaire philanthropist {offer_hero} has secured the future of common people"},
        {'gender': 'male', 'language_id': 1, 'country_id': 2,
         'template': "Bank of England sues {offer_hero} for what he said on live TV"},
        {'gender': 'female', 'language_id': 1, 'country_id': 2,
         'template': "Bank of England sues {offer_hero} for what she said on live TV"},
        {'gender': 'male', 'language_id': 1, 'country_id': 3,
         'template': "{offer_name} steals a march on everyone by making even more money after his new fiance revealed this new method of making money"},
        {'gender': 'male', 'language_id': 1, 'country_id': 2,
         'template': "{offer_name} is being sued by the Bank of England for comments he made on live broadcast"},
        {'gender': 'male', 'language_id': 1, 'country_id': 2,
         'template': "{offer_hero} shocked everyone in the studio by revealing how he is making an extra {currency_symbol}128K every month"},
    ]
    create_objects(titles, Title)
    paragraphs = [
        {
            'template': """The scandal erupted during a live broadcast when {offer_hero} accidentally revealed his secret on the program. Many viewers paid attention to {offer_hero_first_name}'s "accidental" words and began to send messages to the airwaves. However, the program was interrupted by a call from the {central_bank}, who demanded that the program be stopped immediately. """,
            'language_id': 1, 'country_id': 1},
