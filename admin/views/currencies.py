...
class CurrencyView(BaseModelView, model=Currency):
    ...
    column_details_list = [Currency.id, Currency.code, Currency.official_name, Currency.name, Currency.name_plural, Currency.min_dep_amount, Currency.symbol, Currency.exchange_rate]
    column_searchable_list = [Currency.code, Currency.official_name]
    column_sortable_list = [Currency.id, Currency.code, Currency.name]
    form_columns = [Currency.id, Currency.code, Currency.official_name, Currency.name, Currency.name_plural, Currency.min_dep_amount,Currency.symbol, Currency.exchange_rate]
